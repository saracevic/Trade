...
from src.models.trade import ExchangeType, ScannerConfig, ScanResult, TradingPair
...
class TestTradingPair:
    ...
    def test_create_valid_trading_pair(self):
        ...
        pair = TradingPair(
            symbol="BTC/USDT", exchange="binance", price=45000.0, volume_24h=1000000.0
        )
    ...
    def test_trading_pair_invalid_price(self):
        ...
        with pytest.raises(ValidationError):
            TradingPair(symbol="BTC/USDT", exchange="binance", price=-100.0, volume_24h=1000000.0)

    def test_trading_pair_invalid_volume(self):
        """Test that negative volume raises validation error."""
        with pytest.raises(ValidationError):
            TradingPair(symbol="BTC/USDT", exchange="binance", price=45000.0, volume_24h=-1000.0)
...
class TestScannerConfig:
    ...
    def test_config_with_defaults(self):
        ...
        config = ScannerConfig(api_keys={}, api_secrets={})
...
class TestScanResult:
    ...
    def test_create_successful_scan_result(self, sample_trading_pairs):
        ...
        result = ScanResult(
            exchange="binance", pairs=sample_trading_pairs, duration=1.5, success=True
        )
    ...
    def test_create_failed_scan_result(self):
        ...
        result = ScanResult(
            exchange="binance", pairs=[], duration=0.5, success=False, error="Connection timeout"
        )
    ...
    def test_scan_result_negative_duration(self):
        ...
        with pytest.raises(ValidationError):
            ScanResult(exchange="binance", pairs=[], duration=-1.0, success=True)
